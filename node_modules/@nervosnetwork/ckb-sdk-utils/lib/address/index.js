...
const toAddressPayload = (args, type = AddressType.HashIdx, codeHashOrCodeHashIndex, hashType) => {
    ...
    if (![AddressType.HashIdx, AddressType.DataCodeHash, AddressType.TypeCodeHash, AddressType.FullVersion].includes(type)) {
        throw new exceptions_1.AddressFormatTypeException(+type);
    }
    ...
    if (!codeHashOrCodeHashIndex) {
        codeHashOrCodeHashIndex = type === AddressType.HashIdx ? '0x00' : systemScripts_1.SECP256K1_BLAKE160.codeHash;
    }
    ...
    if (!hashType && codeHashOrCodeHashIndex === systemScripts_1.SECP256K1_BLAKE160.codeHash) {
        hashType = systemScripts_1.SECP256K1_BLAKE160.hashType;
    }
...
const bech32Address = (args, { prefix = AddressPrefix.Mainnet, type = AddressType.HashIdx, codeHashOrCodeHashIndex = '' } = {}) => __1.bech32.encode(prefix, __1.bech32.toWords((0, exports.toAddressPayload)(args, type, codeHashOrCodeHashIndex)), MAX_BECH32_LIMIT);
...
const isValidShortVersionPayload = (payload, bech32Type) => {
    ...
    if (bech32Type !== Bech32Type.Bech32) {
        throw new exceptions_1.AddressFormatTypeAndEncodeMethodNotMatchException(type, bech32Type);
    }
    switch (index) {
        case 0:
        case 1: {
...
const parseAddress = (address, encode = 'binary') => {
    ...
    try {
        ...
        if (err instanceof exceptions_1.AddressFormatTypeAndEncodeMethodNotMatchException) {
            throw err;
        }
